...
from wrw.views.update_factor_severities import UpdateFactorSeveritiesPage
...
urlpatterns = [
    ...
    path('user/<int:user_id>/update_factor_severities/',
         csrf_exempt(UpdateFactorSeveritiesPage.as_view())),
]
